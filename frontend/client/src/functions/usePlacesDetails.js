...
// commenting with psuedo-code :

export default function usePlacesDetails(url) {
  // fetch single-resource data from Firebase URL
  // let serviceName = res.data.name;

  // send a single field (likely name) from results to Google Places Search API to get place_id
  // send place_id to Google Places Details API to return places details
  return null;
}

//  Google Places Details returns an object with this shape:
//  {
//     "html_attributions" : [],
//     "result" : {
//        "address_components" : [
